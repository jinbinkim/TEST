					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Binding -생성,삭제,변경",
									"targetURL": "#zproject4-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zproject4-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zproject4",
									"url": sap.ui.require.toUrl("zproject4")
								}
							}
						}
					}
